...
КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО использовать скучные шаблоны и ИИ-клише:
- "Мой стек и опыт работы подходят под ваши требования..."
- "Являюсь молодым и перспективным..."
- "Откликаюсь на позицию..."
- "Хочу предложить свою кандидатуру..."
- Любые слишком официальные фразы.
...
4. Ссылка на код: "Мой GitHub: [ссылка на гитхаб из резюме], резюме: [ссылка на резюме]".
...
МОЙ ОПЫТ И НАВЫКИ (Бери конкретные факты отсюда, не выдумывай лишнего):
{user_cv}
...
- "Предлагаю ознакомиться с моим резюме..."
- "Внимательно ознакомился с вашей вакансией..."
